...
correspondance_avions_moteurs = {
    ...
    'AIRBUS A340 300': ('CFM56-5C4', 4, 39000, 0.84),
    'AIRBUS A340 600': ('Trent 556-61', 4, 39000, 0.84),
    'ATR ATR72': ('Hélice', 2, 25000, 0.52),
    'BAE ATP': ('Hélice', 2, 25000, 0.72),
    'BAE AVRO 146RJ 200': ('ALF 502R-5', 4, 35000, 0.75),
    'BAE AVRO 146RJ 300': ('ALF 502R-5', 4, 35000, 0.75),
    'BAE JETSTREAM31 3100': ('Hélice', 2, 25000, 0.37),
    'BAE JETSTREAM41 4100': ('Hélice', 2, 25000, 0.37),
    'BEECH 300': ('Hélice', 2, 25000, 0.37),
    'BOEING 737 300': ('CFM56-3-B1', 2, 41000, 0.82),
    'BOEING 737 400': ('CFM56-3C-1', 2, 41000, 0.82),
    'BOEING 737 500': ('CFM56-3-B1', 2, 41000, 0.82),
    'BOEING 737 700': ('CFM56-7B20', 2, 41000, 0.82),
    'BOEING 737 800': ('CFM56-7B26', 2, 41000, 0.82),
    'BOEING 747 400': ('PW4062', 4, 35000, 0.86),
    'BOEING 747 400F': ('PW4062', 4, 35000, 0.86),
    'BOEING 757 200': ('PW2040', 2, 38000, 0.86),
    'BOEING 757 300': ('RB211-535C', 2, 38000, 0.86),
    'BOEING 767 300ER': ('PW4060', 2, 35000, 0.84),
    'BOEING 777 200': ('GE90-77B', 2, 39000, 0.86),
    'BOEING 777 200ER': ('GE90-85B', 2, 39000, 0.86),
    'BOEING 777 300': ('PW4098', 2, 39000, 0.86),
    'BOMBARDIER BD1001A10': ('HTF7350 (AS907-2-1A)', 2, 45000, 0.82),
    'BOMBARDIER BD7001A10': ('BR700-710D5-21', 2, 42000, 0.85),
    'CANADAIR CL6002B16': ('CF34-3A', 41000, 0.82),
    'DASSAULT FALCON 2000': ('PW308C', 2, 48000, 0.84),
    'DASSAULT FALCON 900': ('TFE731-3', 2, 51000, 0.85),
    'DASSAULT FALCON7X': ('PW307A', 3, 42000, 0.87),
    'DE HAVILLAND CANADA DHC8 300': ('Hélice', 2, 25000, 0.42),
    'DE HAVILLAND CANADA DHC8 400': ('Hélice', 2, 27000, 0.57)}
